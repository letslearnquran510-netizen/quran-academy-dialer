...
import { UserCogIcon, TrashIcon, PlusIcon, SaveIcon, ExclamationTriangleIcon, ClockIcon, StopwatchIcon, ArrowUpIcon, ArrowDownIcon, FilterIcon, XCircleIcon, ChevronUpDownIcon, PencilIcon, CheckIcon, XMarkIcon, CloudUploadIcon } from './icons';
      ...
      <main className="mt-8 space-y-8">
        ...
        <div className="rounded-lg bg-white dark:bg-slate-800 p-6 shadow-md dark:border dark:border-slate-700">
            <div className="flex items-center gap-3 mb-4">
                <CloudUploadIcon className="h-6 w-6 text-sky-600 dark:text-sky-400" />
                <h2 className="text-xl font-bold text-slate-800 dark:text-slate-100">Deployment Checklist</h2>
            </div>
            <div className="text-sm text-slate-600 dark:text-slate-300 space-y-3">
                <p>For login and calling features to work on a live server (like Vercel), you <strong>must</strong> set the following secure environment variables in your hosting provider's project settings.</p>
                <p className="font-semibold">The app will not function correctly until these are configured.</p>
            </div>
            <div className="mt-4 space-y-2 rounded-lg bg-slate-50 dark:bg-slate-900/50 p-4 border border-slate-200 dark:border-slate-700">
                <h3 className="font-bold text-slate-700 dark:text-slate-200">Required Environment Variables:</h3>
                <ul className="list-disc list-inside space-y-1 font-mono text-xs text-slate-800 dark:text-slate-300">
                    <li><code className="bg-slate-200 dark:bg-slate-700 p-1 rounded">ADMIN_PASSWORD</code></li>
                    <li><code className="bg-slate-200 dark:bg-slate-700 p-1 rounded">STAFF_PASSWORD</code></li>
                    <li><code className="bg-slate-200 dark:bg-slate-700 p-1 rounded">TWILIO_ACCOUNT_SID</code></li>
                    <li><code className="bg-slate-200 dark:bg-slate-700 p-1 rounded">TWILIO_AUTH_TOKEN</code></li>
                    <li><code className="bg-slate-200 dark:bg-slate-700 p-1 rounded">TWILIO_PHONE_NUMBER</code></li>
                </ul>
            </div>
            <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">These variables are used by the secure backend functions and are never exposed to the frontend.</p>
        </div>
